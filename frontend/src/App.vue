  ...
  <div class="min-h-screen bg-gray-50 p-4 md:p-6">
    <div class="max-w-3xl mx-auto">
      ...
      <header class="text-center mb-8 mt-4">
        <h1 class="text-3xl font-bold text-gray-900 mb-1">Antibioprophylaxie</h1>
        <h2 class="text-2xl font-semibold text-gray-800 mb-1">en chirurgie</h2>
        <h3 class="text-xl font-medium text-gray-700">et médecine interventionnelle</h3>
      </header>
      ...
      <footer class="mt-16 flex justify-between items-center">
        <div class="flex items-center">
          <img src="/sfar-logo.svg" alt="SFAR" class="h-12" />
        </div>
        ...
        <div>
          <img src="/spilf-logo.svg" alt="SPILF" class="h-12" />
        </div>
      </footer>
    </div>
  </div>
